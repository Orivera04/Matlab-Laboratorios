...
% Last Modified by GUIDE v2.5 08-Apr-2016 19:45:43
...
N = eval(get(handles.edit20,'String'));
SNNumeros(N)
...
B =eval(get(handles.edit11,'String'));
C = eval(get(handles.edit12,'String'));
[X1,X2] = Cuadratica(A,B,C);
set(handles.edit13,'String',X1);
set(handles.edit14,'String',X2);
