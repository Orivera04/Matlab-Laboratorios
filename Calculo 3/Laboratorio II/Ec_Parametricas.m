...
% Last Modified by GUIDE v2.5 17-Aug-2016 21:32:02
...
legend(Concat2);
  ...
  set(handles.edit45,'String',num2str(Valores(4)));
    ...
    msgbox('Error : Verifique no halla dejando algun campo vacio o que las funciones tengan errores de sintaxis','Atención','error');
end 
...
Grafica_Parametrica(F1,F2,A,B,0.0000000000000000000000000000001,0);
             %Vector Velocidad%
           quiver(Cx,Cy,Vx,Vy,'Color','m');            
            quiver(Cx,Cy,Ax,Ay,'Color','b');
            %Vector(Cx,Cy,Vx,Vy);
            %Vector(Cx,Cy,Ax,Ay);
            ...
            Ox = ['<' char(Vx) ',' char(Vy) '>'];
            Oy = ['<' char(Ax) ',' char(Ay) '>'];
            set(handles.text56,'String',Ox);
            set(handles.text57,'String',Oy);
            
            set(handles.edit50,'String',Dx);
            set(handles.edit51,'String',Dy);
            legend('Función ','Vector Velocidad', 'Vector Aceleración');
            %Vector Aceleraciòn%
            %quiver(Cx,Cy,Vx,Vy,'Color','b');
