...
% Last Modified by GUIDE v2.5 22-Aug-2016 16:53:50
...
%handleArray = [handles.axes3  handles.axes5  handles.axes6  handles.axes7];
...
global F1 ;global F2;global A ; global B; global T;
cla;
F1 = (get(handles.edit23,'String'));
F2 = (get(handles.edit30,'String'));
...
Dx = [char(Dx1_X) 'i + ' char(Dx1_Y) 'j'];
Dy = [char(Dx2_X) 'i + ' char(Dx2_Y) 'j'];
...
Vector(0,0,Cx,Cy,'m');
     Dx = [char(Dx1_X) 'i + ' char(Dx1_Y) 'j'];
            Dy = [char(Dx2_X) 'i + ' char(Dx2_Y) 'j'];
            Ox = ['V <' char(Vx +Cx) ',' char(Vy + Cy) '>'];
            Oy = ['A <' char(Ax + Cx) ',' char(Ay + Cy) '>'];
            P = ['P <' char(Cx) ',' char(Cy) '>'];
            set(handles.edit53,'String',Ox);
            set(handles.edit54,'String',Oy);
            set(handles.edit55,'String',P);            
            set(handles.edit50,'String',Dx);
            set(handles.edit51,'String',Dy);        
            pause(0.0000000000000001);  
 end
    for i = A : B
            TabFt{i-A+1} = i;
            TabFx{i-A+1} = num2str(double(subs(F1,'t',i)));   
		    TabFy{i-A+1} = num2str(double((subs(F2,'t',i))));                                                                      
 end 
Concat =[TabFt' TabFx' TabFy'];
set(handles.uitable1,'data',Concat);   
Concat2 = [ {F1 F2}' {num2str(A) num2str(A)}' {num2str(B) num2str(B)}' ];
set(handles.uitable3,'data',Concat2);  
%Concat2  = ['X= ' F1 ' , Y = ' F2 ];
%legend(Concat2);
  Valores = axis;
  set(handles.edit42,'String',num2str(Valores(1)));
  set(handles.edit44,'String',num2str(Valores(2)));
  set(handles.edit43,'String',num2str(Valores(3)));
  set(handles.edit45,'String',num2str(Valores(4)));
  set(handles.text47,'String',num2str(T));
  legend('Función ','Vector velocidad','Vector aceleración', 'Vector Posición');
else
     grid on;        
    t = A : 0.2 : B;
    G = eval(sym(F1));
...
xlim([min(G),max(G)]);
        ylim([min(H),max(H)]); 
            ...
            set(handles.edit50,'String',Dx);
            set(handles.edit51,'String',Dy);           
pause(0.00000000000000000000000000000001);  
 end
   Valores = axis;
  set(handles.edit42,'String',num2str(Valores(1)));
  set(handles.edit44,'String',num2str(Valores(2)));
...
global V
if ((eval(get(handles.edit40,'String'))) >= 0)
V = eval(get(handles.edit40,'String'));    
msgbox('Escala cambiada con exito','Información','warn');
else
    msgbox('El numero tiene que ser mayor que 0','Error','error');
end
...
global T; global F1 ; global F2;global A ; global B;
...
Grafica_Parametrica(F1,F2,A,B,0.000001,0);
             %Vector Velocidad%                                   
            Vector(Cx,Cy,Vx,Vy,'g');
            Vector(Cx,Cy,Ax,Ay,'r');
            Vector(0,0,Cx,Cy,'m');
            ...
            set(handles.edit50,'String',Dx);
            set(handles.edit51,'String',Dy);            
            legend('Función ','Vector Velocidad', 'Vector Aceleración','Vector posicion');
...
if(get(handles.checkbox6,'Value') == 0)
xlim([ eval((get(handles.edit42,'String'))) eval((get(handles.edit44,'String')))]);
ylim([ eval((get(handles.edit43,'String'))) eval((get(handles.edit45,'String')))]);    
else
    axes(handles.axes3);
    xlim([ eval((get(handles.edit42,'String'))) eval((get(handles.edit44,'String')))]);
ylim([ eval((get(handles.edit43,'String'))) eval((get(handles.edit45,'String')))]);
...
T = eval(get(handles.edit52,'String'));
set(handles.text47,'String',num2str(T));
cla;
hold on;
