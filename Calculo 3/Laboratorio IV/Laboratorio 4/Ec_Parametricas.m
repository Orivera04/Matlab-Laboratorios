...
% Last Modified by GUIDE v2.5 28-Aug-2016 20:35:49
...
grid on;    
 ...
 for i = 1 : 1 : length(G)    
            %Aqui van los dibujos de los vectores%
            plot(G(1:1:i),H(1:1:i),'r')
...
R =  1 / O;
    ...
    ylim([Ymin,Ymax]);
            ...
            KT = [num2str(O)];
            Rad = [num2str(R)];
                set(handles.edit55,'String',KT);
                set(handles.edit95,'String',Rad);
            set(handles.edit54,'String',Ox);
            set(handles.edit58,'String',Oy);            
            set(handles.edit51,'String',Dx);
            set(handles.edit59,'String',Dy);            
            
            legend('Recta Normal ','Recta Tangente', 'Centro de la curvatura','Circunferencia de la curvatura','Función parametrica','Vector Velocidad','Vector Aceleración','Vector Posición');
...
CompTan = char(subs(diff(sym(RaizTan)), 't', T));

%Valores a utilizar en Normal
CompNormal = char(subs(VarNorm, 't', T));
                set(handles.edit92,'String',CompNormal);
                                set(handles.edit93,'String',CompTan);
