...
%
%      PRESENTACION('Property','Value',...) creates a new PRESENTACION using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to Presentacion_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      PRESENTACION('CALLBACK') and PRESENTACION('CALLBACK',hObject,...) call the
...
% Last Modified by GUIDE v2.5 21-Aug-2016 14:38:43
